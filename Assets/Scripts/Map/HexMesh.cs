...
namespace Assets.Scripts.Map
{
    ...
    public sealed class HexMesh : MonoBehaviour
    {
        ...
        )
        {
            ...
            // Четырехугольники для промежуточных уступов
            ...
            // Последний четырехугольник, соединяющийся с левой и правой ячейками
        ...
        {
            // Находим границу на обрыве
            float b = 1f / (rightCell.Elevation - beginCell.Elevation);
            if (b < 0) b = -b; // Защита от отрицательных значений
            Vector3 boundary = Vector3.Lerp(begin, right, b);
            Color boundaryColor = Color.Lerp(beginCell.Color, rightCell.Color, b);

            // Триангулируем нижнюю часть (склон, сходящийся к границе обрыва)
            TriangulateBoundaryTriangle(begin, beginCell, left, leftCell, boundary, boundaryColor);

            // Триангулируем верхнюю часть (между левой и правой ячейками)
        ...
        {
            // Первый маленький треугольник у начала склона
            ...
            // Последующие треугольники, формирующие уступы
            for (int i = 2; i < HexMetrics.TERRACE_STEP; i++)
            {
                Vector3 v1 = v2;
                Color c1 = c2;
            ...
            // Последний треугольник, соединяющийся с левой ячейкой
        ...
        )
        {
            ...
            // Комбинации: два склона, склон+ровное, склон+обрыв, обрыв+склон, обрыв+обрыв+склон
            ...
            {
                // Простой треугольник для всех остальных случаев (ровно-ровно-ровно и др.)
